...
@foreach( $locations as $location)
	...
	<td class ="text-left">{{HTML::linkRoute('edit_locations','EDIT',array($location->location_name))}}</td>
	<td class = "text-left">{{HTML::linkRoute('delete_locations','DELETE',array($location->location_name))}}</td>
	</tr>
	@endforeach
